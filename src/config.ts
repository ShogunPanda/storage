...
export function getConfig(options?: { reload?: boolean }): StorageConfigType {
  ...
  config = {
    ...
    // Profiling uses a dedicated bucket/client and remains off until a trigger fires.
    ...
    profilingSevereElu: envSampleRate(getOptionalConfigFromEnv('PROFILING_SEVERE_ELU'), 0.8),
